...
const getChildHierarchyHelper = (state: Map<number, HierarchyRecord>, index: number, acc: number[]): ?number => {
...
export const getRow = (hierarchy: HierarchyRecord, rowIndex: number): ?HierarchyRowRecord => {
    return hierarchy.payload.find((row) => row.rowIndex == rowIndex);
}

export const getChildHierarchies = (state: Map<number, HierarchyRecord>, index: number) => {
    const accumulator = []
...
export const deleteHierarchyIfRowsEmpty = (state: Map<number, HierarchyRecord>, hierarchyIndex: number): Map<number, HierarchyRecord> => {
...
export const updateExpansionAndChildIds = (state: Map<number, HierarchyRecord>) => {
